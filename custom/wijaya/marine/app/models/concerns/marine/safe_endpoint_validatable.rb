# Mirrors Concerns::SafeEndpointValidatable (Captain) but kept under the Marine
# namespace so Marine custom tools stay fully independent from Captain/enterprise.
